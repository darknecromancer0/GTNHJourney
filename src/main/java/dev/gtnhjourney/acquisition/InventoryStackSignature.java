 ...
 * net for hash collisions and for meaningful payload mutations that coexist with a BASE charge endpoint.</p>
 */
public final class InventoryStackSignature {
    ...
    public static int of(ItemStack stack) {
        ...
        try {
            ...
            if (stack.getItem().isDamageable() && !stack.getItem().getHasSubtypes()) meta = 0;
            hash = 31 * hash + meta;
