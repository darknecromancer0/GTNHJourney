...
public class MainInventoryFillServiceTest {
    ...
    public void fillsOnlyEmptyMainSlotsWithNaturalMaxStacks() {
        Item stackable = testItem(64);
        ItemStack[] slots = new ItemStack[5];
        slots[1] = new ItemStack(stackable, 7);
        slots[3] = new ItemStack(stackable, 2);
        ItemStack template = new ItemStack(stackable, 1);
    ...
    public void nonStackableItemsFillOnePerEmptySlot() {
        ...
        slots[1] = new ItemStack(testItem(64), 1);

        int filled = MainInventoryFillService.fillEmptySlots(slots, new ItemStack(testItem(1), 1), 64);
    ...
    public void exactTemplateNbtIsCopiedIndependentlyIntoEverySlot() {
        ...
        ItemStack template = new ItemStack(testItem(64), 1);
    ...
    private static Item testItem(int maxStackSize) {
        return new Item().setMaxStackSize(maxStackSize);
    }
}
